...
(function (GrowthMessage) {
    var Dialog = (function (_super) {
        ...
        Dialog.prototype.bindEvents = function () {
            var _this = this;
            this.el.getElementsByClassName('js__btn-close')[0].addEventListener('click', function () {
                _this.hide();
            });
        };
        return Dialog;
